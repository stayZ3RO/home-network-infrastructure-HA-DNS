...
![Bridge Mode Enabled](../../screenshots/phase-1/4-bridge-mode-enabled.png)

## Deco Mesh Network Active
![Deco Network](../../screenshots/phase-1/2-deco-network-connected.png)
![Deco - Connected Devices](../../screenshots/phase-1/3-deco-connected-devices.png)
